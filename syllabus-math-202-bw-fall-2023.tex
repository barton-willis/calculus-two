...
Your course grade will be based on twenty-six in class assignments, four midterm exams, three online homework assignments,  and a comprehensive final exam; specifically:
\FPeval{\hwpts}{round(26*6,0)}
\begin{mypar}{0.25in}{0.25in}
    \textbf{In class work}  \emph{Twenty-six six  point assignments}  \dotfill \hwpts \/ (total) \\
...
\begin{alphalist}
   ...
   \item Pursuant to UNK policy for a five credit class,  Midterm exam \rom{4} will be given during final exam week.
    ...
    \item In class work (labeled \textbf{IC}) will generally be given on Tuesday and Thursday of the week they are assigned.  
...
\wk    & \printdate{20/11/\the\year} & \S10.2 -- \S10.3   & Calculus with parametric curves,  Polar Coordinates & \hw, \hw \\
