...
\end{tikzpicture}
\textbf{\mbox{The 45-45-90 triangle}} \\
...
licensed under Attribution 4.0 International (CC BY 4.0) \,  \qrcode[height=0.25in]{https://creativecommons.org/licenses/by/4.0/}. For the current version of
this document, visit \, \qrcode[height=0.25in]{https://github.com/barton-willis/calculus-two} 
