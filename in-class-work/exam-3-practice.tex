...
\large
\vspace{0.1in}
\noindent\makebox[3.0truein][l]{{\bf MATH 202 Spring 2010}}
{\bf Name:}\hrulefill\
...
\begin{solution}[2.5in] We need to use the absolute ratio test; for \(x \neq 0\), we have
\[
...
\begin{parts}
    ...
    \begin{solution}[3.05in] Let's go to our happy place; for all real $x$, we have
        \begin{equation*}
