...
\begin{questions} 
    ...
    \mbox{$\displaystyle
        \int_0^\infty F(x) \, \mathrm{d} x = \lim_{a \to \infty}  \int_0^a F(x) \, \mathrm{d} x.
    $}
...
\newpage
 \question The 1987 Edition of \emph{Larry's Obscure Table of Obscure but 
 Useful Integrals}, lists the antiderivative
 (reprinted with permission)
 $    \int 2 \lfloor x \rfloor  \, \mathrm{d} x = 
     (2x -1) \lfloor x \rfloor -\lfloor x \rfloor^2$.
  
\begin{parts}

    \part [1] Use Desmos to graph $y = (2x -1) \lfloor x \rfloor -\lfloor x \rfloor^2$
