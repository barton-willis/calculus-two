...
\begin{questions} 
  ...
  \includegraphics[scale=0.2]{desmos-graph(69).png}
    ...
    \begin{solution}%[2.5in]
     ...
     the equations
     \begin{equation*}
        \left[ 0 = \frac{t}{1+t^2} ,  2 = \frac{2t^2}{1+ t^2} \right] = \left[ 0 = t, 2 + 2t^2 = 2 t^2 \right].
    \end{equation*}
...
\quad The picture might make us think that there is a HT when   $x=0$ and $y=2$. But $(x=0, y=2)$ is not a point
on the curve $\mathcal{C}$, so the curve doesn't have an HT at $(x=0, y=2)$. 
    \end{solution}
...
\end{cases}$. And it's a good thing we didn't prove it because it is false.  We have $(x=0,y=2)$ is a point on 
