...
\newcommand{\quiz}{4(a)}
\newcommand{\term}{Fall}
\newcommand{\due}{Tuesday 12 September 13:20}
...
\question [1] Show that $ 3 y^2 = 2 x^3 + C$ is a GS to the DE $\displaystyle y \frac{\mathrm{d} y}{\mathrm{d} x} = x^2$.
...
the following antiderivatives. To find each antiderivative, make a
change of variable of the form $x = \alpha z$, where $\alpha$ is a
cleverly choosen number.
