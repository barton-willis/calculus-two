...
\begin{questions} 
        ...
        \begin{parts}
            ...
            \begin{solution}[3.0in]
                \begin{equation*}
                    \mbox{Area}(Q) = \int_0^5  x \mathrm{e}^{-x} \, \mathrm{d} x 
                     = 1 - \frac{6}{\mathrm{e}^5} \approx 0.9595723180054871.
                \end{equation*}  
            \end{solution}
            ...
            \begin{solution}%[3.0in]
                \begin{equation*}
                \mbox{Area}(Q) \overline{x} = \int_0^5  x^2 \mathrm{e}^{-x} \, \mathrm{d} x
                   = 2 - \frac{37}{\mathrm{e}^5}
                \end{equation*}
                So 
                \begin{equation*}
                   \overline{x} = \frac{2-37 {\mathrm{e}^{-5}}}{1-6 {\mathrm{e}^{-5}}}
                     \approx 1.824454424313464
                \end{equation*}
            \end{solution}
        \end{parts}
